...
function ReactorManager:setErrorText( errorText )
    self.errorText = errorText
end

function ReactorManager:ReactorManager( checkBox, statusText )
    self.checkBox = checkBox
    checkBox.reactorManager = self
    self.statusText = statusText

    function checkBox:onCheck()
        rednet.broadcast("on", "reactor")
    end

    function checkBox:onUnCheck()
        rednet.broadcast("off", "reactor")
    end
end
